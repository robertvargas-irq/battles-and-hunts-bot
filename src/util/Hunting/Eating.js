...
class Eating {
    ...
    static noFoodInPileEmbed = EmbedBuilder.from({
        color: 'Red',
        title: '🦴 Wonderful...',
     ...
     * @param {prey[]} consumed 
     */
    static generateDishonestAlertEmbed = (consumed) => EmbedBuilder.from({
        color: 'Red',
     ...
     * @param {prey[]} consumed 
     */
    static generateDishonestResultEmbed = (character, consumed) => EmbedBuilder.from({
        color: 'DarkGreen',
     ...
     * @param {prey[]} consumed 
     */
    static generateHonestResultEmbed = (character, consumed) => EmbedBuilder.from({
        color: 'Green',
    ...
    static generateStolenFoodAlertEmbed = (character, member, bitesTaken, consumed) => EmbedBuilder.from({
        color: 'Red',
    ...
    static generateEatenFoodAlertEmbed = (character, member, bitesTaken, consumed) => EmbedBuilder.from({
        color: 'Aqua',
        author: {
